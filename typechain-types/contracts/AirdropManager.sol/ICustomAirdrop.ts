...
export interface ICustomAirdropInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowAddress"
      | "allowAddresses"
...
export interface ICustomAirdrop extends BaseContract {
  connect(runner?: ContractRunner | null): ICustomAirdrop;
  waitForDeployment(): Promise<this>;

  interface: ICustomAirdropInterface;
